        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/background-laptop.jpg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Ramadhan Ibnu Khatamsyah</a></h1>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/ramadhan-ibnu-bb3241172/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
