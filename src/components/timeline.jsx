                ...
                <div className="timeline-centered">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Gunadarma University<span>2014-2020</span></h2>
                        <p>I have finished my studies at Gunadarma University majoring in informatics engineering, there I got knowledge about programming fundamentals.</p>
                      </div>
                    </div>
                  </article>
                </div>
